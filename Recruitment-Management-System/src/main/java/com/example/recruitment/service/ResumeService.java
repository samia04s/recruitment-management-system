...
//        String folder = "uploaded-resumes/";
//        File dir = new File(folder);
//        if (!dir.exists()) dir.mkdirs();
//
//        String filepath = folder + userId + "-" + file.getOriginalFilename();
...
//        }
//
//        // Prepare multipart/form-data for third-party API
//        MultiValueMap<String, Object> body = new LinkedMultiValueMap<>();
//        body.add("file", new FileSystemResource(savedFile));
//        HttpHeaders headers = new HttpHeaders();
//        headers.setContentType(MediaType.MULTIPART_FORM_DATA);
//        headers.set("X-API-KEY", resumeApiKey);
//
...
//        String skills = responseBody != null ? (String) responseBody.getOrDefault("skills", "") : "";
//        String education = responseBody != null ? (String) responseBody.getOrDefault("education", "") : "";
//        String experience = responseBody != null ? (String) responseBody.getOrDefault("experience", "") : "";
//
...
//        }
//
//        // Prepare multipart data to send to third-party resume parsing API
//        MultiValueMap<String, Object> body = new LinkedMultiValueMap<>();
//        body.add("file", new FileSystemResource(savedFile));
//        HttpHeaders headers = new HttpHeaders();
//        headers.setContentType(MediaType.MULTIPART_FORM_DATA);
//        headers.set("apikey", resumeApiKey);
//
//        HttpEntity<MultiValueMap<String, Object>> requestEntity = new HttpEntity<>(body, headers);
//
//        ResponseEntity<Map> response;
